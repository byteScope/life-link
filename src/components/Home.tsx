  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {quickAccessTiles.map((tile) => (
              <Link key={tile.title} to={tile.path}>
                <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer border-0 rounded-2xl bg-white shadow-md">
                  <div
        ...
        {/* Services Section - White background, Care.com style */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {services.map((service, index) => (
                <Link key={service.title} to={service.path}>
                  <Card className={`p-4 hover:shadow-md transition-all duration-300 cursor-pointer border rounded-2xl bg-white h-48 flex flex-col group ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature) => (
                <Card key={feature.title} className="p-8 text-center rounded-2xl border-0 shadow-sm bg-white">
